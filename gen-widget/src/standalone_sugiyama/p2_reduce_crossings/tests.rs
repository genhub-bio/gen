...
mod insert_dummy_vertices {
    ...
    use crate::standalone_sugiyama::p2_reduce_crossings::{
...
mod init_order {
    ...
    use crate::standalone_sugiyama::p2_reduce_crossings::insert_dummy_vertices;
...
mod order {
    ...
    use crate::standalone_sugiyama::{Edge, Vertex, p2::order_layer, p2_reduce_crossings::Order};
    ...
    fn test_barycenter() {
        ...
        let expected_order = order_layer(
            ...
            false,
            &order,
            crate::standalone_sugiyama::p2_reduce_crossings::barycenter,
        );
        assert_eq!(
