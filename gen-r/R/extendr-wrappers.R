...
update_with_fasta <- function(workspace_path = NULL, db_path = NULL, filename, name = NULL, sample, new_sample, region_name, start = NULL, end = NULL) {
...
update_with_library_files <- function(workspace_path = NULL, db_path = NULL, name = NULL, sample, new_sample, path_name, start = NULL, end = NULL, library, parts) {
  .Call(wrap__update_with_library_files, workspace_path, db_path, name, sample, new_sample, path_name, start, end, library, parts)
}

update_with_library <- function(workspace_path = NULL, db_path = NULL, name = NULL, sample = NULL, new_sample_name, path_name, start = NULL, end = NULL, parts_list) {
  .Call(wrap__update_with_library, workspace_path, db_path, name, sample, new_sample_name, path_name, start, end, parts_list)
}

update_with_sequence <- function(workspace_path = NULL, db_path = NULL, sequence, name = NULL, sample, new_sample, region_name, start = NULL, end = NULL, no_reference_path_update = FALSE) {
...
repo_create_block_group <- function(db_path, name, collection_name, sample_name) .Call(wrap__repo_create_block_group, db_path, name, collection_name, sample_name)
