...
/// three manage overlay display through the same vocabulary. Track overlays come from
/// annotation files or database groups; ad hoc overlays are used for temporary search
/// highlights.
#[derive(Clone)]
