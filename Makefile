.PHONY: python python-wheel py-package-cli jupyter r r-test release-check-js clean build clippy-fix docker-build gif wasm wasm-test
python:
...
r-test:
	...
	bash -o pipefail -c 'DOCKER_BUILDKIT=1 docker build -t gen-r -f ./gen-r/Dockerfile \
